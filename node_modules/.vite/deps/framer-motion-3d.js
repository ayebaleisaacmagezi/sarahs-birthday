  ...
  return new Proxy(deprecatedFactoryFunction, {
    ...
    get: (_target, key) => {
      ...
      if (!componentCache2.has(key)) {
        componentCache2.set(key, componentFactory(key));
      }
...
// node_modules/framer-motion/dist/es/motion/utils/use-visual-element.mjs
function useVisualElement(Component4, visualState, props, createVisualElement2, ProjectionNodeConstructor) {
  var _a, _b;
  ...
  if (!visualElementRef.current && createVisualElement2) {
    visualElementRef.current = createVisualElement2(Component4, {
      visualState,
      parent,
      props,
      presenceContext,
...
// node_modules/framer-motion/dist/es/motion/index.mjs
function createRendererMotionComponent({ preloadedFeatures: preloadedFeatures2, createVisualElement: createVisualElement2, useRender: useRender2, useVisualState: useVisualState3, Component: Component4 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    if (!isStatic && isBrowser) {
      ...
      context.visualElement = useVisualElement(Component4, visualState, configAndProps, createVisualElement2, layoutProjection.ProjectionNode);
    }
    return (0, import_jsx_runtime7.jsxs)(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? (0, import_jsx_runtime7.jsx)(MeasureLayout2, { visualElement: context.visualElement, ...configAndProps }) : null, useRender2(Component4, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, context.visualElement)] });
  }
...
function createUseRender(forwardMotionProps = false) {
  const useRender2 = (Component4, props, ref, { latestValues }, isStatic) => {
    const useVisualProps2 = isSVGComponent(Component4) ? useSVGProps : useHTMLProps;
    const visualProps = useVisualProps2(props, latestValues, isStatic, Component4);
...
// node_modules/framer-motion/dist/es/motion/utils/use-visual-state.mjs
function makeState({ scrapeMotionValuesFromProps: scrapeMotionValuesFromProps4, createRenderState: createRenderState2 }, props, context, presenceContext) {
  const state = {
...
function createMotionComponentFactory(preloadedFeatures2, createVisualElement2) {
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react28.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
function useTap(isStatic, { whileTap, onTapStart, onTap, onTapCancel, onPointerDown }, visualElement) {
  ...
  const isPressing2 = (0, import_react49.useRef)(false);
  ...
  return {
    onPointerDown: addPointerInfo((event, info) => {
      var _a;
      removePointerEndListener();
      if (isPressing2.current)
        return;
      isPressing2.current = true;
      const options = {
...
// node_modules/framer-motion-3d/dist/es/render/use-render.mjs
var useRender = (Component4, props, ref, _state, isStatic, visualElement) => {
  const visualProps = useVisualProps(props);
  return (0, import_react50.createElement)(Component4, {
    ref,
...
var MotionCanvasContext = (0, import_react51.createContext)(void 0);
...
function CanvasComponent({ children, fallback, tabIndex, id: id3, style, className, events: events$1, ...props }, forwardedRef) {
  const motionContext = (0, import_react52.useContext)(MotionContext);
  const configContext = (0, import_react52.useContext)(MotionConfigContext);
  const [forceRender] = useForceUpdate();
  const layoutCamera = (0, import_react52.useRef)(null);
  const dimensions = (0, import_react52.useRef)({
  ...
  (0, import_react52.useLayoutEffect)(handleResize, []);
  ...
  if (error)
    throw error;
  const root = (0, import_react52.useRef)(null);
  if (size.width > 0 && size.height > 0) {
    ...
    }).render((0, import_jsx_runtime12.jsx)(ErrorBoundary, { set: setError, children: (0, import_jsx_runtime12.jsx)(React4.Suspense, { fallback: (0, import_jsx_runtime12.jsx)(Block, { set: setBlock }), children: (0, import_jsx_runtime12.jsx)(MotionCanvasContext.Provider, { value: {
      dimensions,
      layoutCamera,
      requestedDpr: calculateDpr(props.dpr)
    }, children: (0, import_jsx_runtime12.jsx)(MotionConfigContext.Provider, { value: configContext, children: (0, import_jsx_runtime12.jsx)(MotionContext.Provider, { value: motionContext, children }) }) }) }) }));
  }
  useIsomorphicLayoutEffect(() => {
    const container = canvasRef.current;
    return () => unmountComponentAtNode(container);
  }, []);
  return (0, import_jsx_runtime12.jsx)("div", { ref: containerRef, id: id3, className, tabIndex, style: {
    position: "relative",
    width: "100%",
    height: "100%",
    overflow: "hidden",
    ...style
  }, children: (0, import_jsx_runtime12.jsx)("canvas", { ref: o([canvasRef, forwardedRef]), style: { display: "block" }, children: fallback }) });
}
var MotionCanvas = (0, import_react52.forwardRef)(CanvasComponent);
...
function useLayoutCamera({ makeDefault = true }, updateCamera) {
  const context = (0, import_react53.useContext)(MotionCanvasContext);
  ...
  const { visualElement: parentVisualElement } = (0, import_react53.useContext)(MotionContext);
  const measuredLayoutSize = (0, import_react53.useRef)(void 0);
...
var LayoutCamera = (0, import_react54.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime13.jsx)(motion2.perspectiveCamera, { ref: o([cameraRef, ref]), ...props });
});
...
var LayoutOrthographicCamera = (0, import_react55.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime14.jsx)(motion2.orthographicCamera, { left: size.width / -2, right: size.width / 2, top: size.height / 2, bottom: size.height / -2, ref: o([cameraRef, ref]), ...props });
});
